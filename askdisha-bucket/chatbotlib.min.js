setTimeout(() => {
  console.log("CoRover bot enabled");
...
script2.src = "https://cdn.jsdelivr.net/gh/ankurkthakur/assets-disha@latest/askdisha-bucket/chatbot_IRCTC_V2.js"+new Date().getTime();
// script2.src =
